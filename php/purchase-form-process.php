<?php
    ...
    if(isset($_POST["email"]) && $_POST["email"] != "") {
        if(filter_var($_POST["email"], FILTER_VALIDATE_EMAIL)) {
            ...
            $body .="Best Way to Contact: ".$userLogistics. "\r\n";
            $headers = "From: $userEmail. \r\n";
            $success = mail($to, "New Purchase!", $body, $headers);
        if($success) {
          $message_sent = true;
          echo'<!DOCTYPE html>
          <html lang="en">
              ...
              <section id="contact">
                <div class="container">
                  <div class="row justify-content-center">
                    <div class="col-md-10">
                      <h3 class="display-5">Thank you for your purchase. I will get back to you as soon as possible!</h3>
